...
public class MainActivity extends AppCompatActivity {
    ...
    private FloatingActionButton capture,detect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        capture = findViewById(R.id.captur_button);
    ...
    private void displayTextFromImage(FirebaseVisionText firebaseVisionText) {
        ...
        if(blockList.size()==0){
            ...
            for(FirebaseVisionText.Block blocks: firebaseVisionText.getBlocks()){
                String text = blocks.getText();
                detectedText = detectedText.concat(text);
            }
